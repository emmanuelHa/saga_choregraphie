package  com.soat.formation.saga.stock.application.web.controller;

import com.soat.formation.saga.stock.application.web.exception.ImpossibleAddStockException;
import com.soat.formation.saga.stock.application.web.exception.StockNotFoundException;
...
public class StockController {
    ...
    private final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(StockController.class);
