...
@Configuration
@EnableJpaRepositories("com.soat.formation.saga.stock.infra.dao")
...
public class DatabaseConfiguration {
    ...
    public DataSource getDataSource() {
        ...
        dataSourceBuilder.url("jdbc:h2:file:"+projectPath+ File.separator+"DB/:stockdb;AUTO_SERVER=TRUE");
