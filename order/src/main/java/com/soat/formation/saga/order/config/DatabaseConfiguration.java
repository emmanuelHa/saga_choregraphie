...
@Configuration
@EnableJpaRepositories("com.soat.formation.saga.order.infra.dao")
...
public class DatabaseConfiguration {
    ...
    public DataSource getDataSource() {
        ...
        dataSourceBuilder.url("jdbc:h2:file:"+projectPath+ File.separator +"DB/:orderdb;AUTO_SERVER=TRUE");
