...
public class PaymentController {
    ...
    public ResponseEntity<HttpStatus> ajouterPaiement(@RequestBody String uuidAndPrice) {
        try {
            JSONObject jsonObject = new JSONObject(uuidAndPrice);
            String uuid = (String) jsonObject.get("uuid");
            Float amount = Float.valueOf((String) jsonObject.get("price"));
            Payment payment = new Payment(uuid, amount);
            //OrderCreated orderCreated = new OrderCreated()
            //UUID newPaymentId = paymentService.save(payment, orderCreated);
