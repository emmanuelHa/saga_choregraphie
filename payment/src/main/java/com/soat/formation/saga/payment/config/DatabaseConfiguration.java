...
@Configuration
@EnableJpaRepositories("com.soat.formation.saga.payment.infra.dao")
...
public class DatabaseConfiguration {
    ...
    public DataSource getDataSource() {
        ...
        dataSourceBuilder.url("jdbc:h2:file:"+projectPath+ File.separator +"DB/:paymentdb;AUTO_SERVER=TRUE");
